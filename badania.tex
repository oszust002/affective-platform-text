...
W ramach dodatkowych uwag badane osoby głównie zwróciły uwagę na pomiar przy pomocy elektrod, który określiły jako mało inwazyjny. Jedna osoba opisała gry wykorzystujące pętlę afektywną jako ciekawe nowe wyzwanie wymagające skupienia się nie tylko na rozgrywce, ale również na swoich emocjach i~reakcjach. Podczas rozmów badane osoby wskazywały elementy, które można poprawić w~grze, takie jak wspomniane wcześniej mechaniki afektywne.
